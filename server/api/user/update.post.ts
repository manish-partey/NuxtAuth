...
export default defineEventHandler(async (event) => {
  ...
  // Permission check - e.g. org_admin can only update users in their org, cannot change role higher than their own
  if (currentUser.role === 'org_admin' && userToUpdate.organizationId?.toString() !== currentUser.organizationId) {
