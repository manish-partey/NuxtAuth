...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p class="mt-4 text-center">Already have an account? `);
...
//# sourceMappingURL=register-i4L_Be_k.mjs.map
