    ...
    <div v-else>
      ...
      <div class="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
        <NuxtLink to="/org/requirements" class="dashboard-action-card">
          ...
          <span class="text-indigo-600 hover:underline font-medium">Document Requirements</span>
        </NuxtLink>
        ...
        <NuxtLink to="/org/documents" class="dashboard-action-card">
          <svg class="h-6 w-6 text-indigo-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
          </svg>
          <span class="text-indigo-600 hover:underline font-medium">Manage Documents</span>
        </NuxtLink>
