  ...
  <nav class="flex items-center space-x-4" aria-label="Primary navigation">
    <template v-if="authStore.loggedIn && authStore.user">
      ...
      <template v-if="authStore.isSuperAdmin">
        ...
        <NuxtLink to="/superadmin/platforms" class="text-sm font-medium text-gray-700 hover:text-blue-600">Platforms
        </NuxtLink>
        <NuxtLink to="/superadmin/organizations" class="text-sm font-medium text-gray-700 hover:text-blue-600">
          Organizations</NuxtLink>
        <NuxtLink to="/superadmin/settings" class="text-sm font-medium text-gray-700 hover:text-blue-600">Settings
        </NuxtLink>
      </template>
    ...
    <template v-else>
      ...
      <NuxtLink to="/organization-register" class="text-sm font-medium text-gray-700 hover:text-blue-600">Register Org
      </NuxtLink>
    </template>
  </nav>
</template>
